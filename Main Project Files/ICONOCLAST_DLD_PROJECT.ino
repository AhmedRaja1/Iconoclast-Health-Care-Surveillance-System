...
#define DEBUG true
#define SSID "Steve Jobs"     // "SSID-WiFiname"
#define PASS "ahmedrajaz345" // "password"
...
String msg = "GET /update?key=WCQ17PGF7MGO6ANF"; 
...
void setup()
{
  ...
  // Double-check the "pulseSensor" object was created and "began" seeing a signal. 
   if (pulseSensor.begin()) {
    Serial.println("RELIANCE ICONOCLAST MEDICAL APP  !");  //This prints one time at Arduino power-up,  or on Arduino reset.  
  }
  Serial.println("AT");
  esp8266.println("AT");
